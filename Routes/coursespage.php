    ...
    <div class="card-container">
      <div class="card border border-dark rounded">
        ...
        <div class="card-body">
          ...
          <a href="courses/java.html" class="btn btn-primary">Go to course</a>
          <br>
          <form method="POST">
          <input type="submit" name='java_course' value="Register now" method="POST" class="btn btn-primary"></input>
          </form>
          <?php
      ...
      <div class="card border border-dark rounded">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Programming Language.</p>
          <a href="courses/python.html" class="btn btn-primary">Go to course</a>
          <br>
          <form method="POST">
          <input type="submit" name="python_course" value="Register now" class="btn btn-primary"></input> 
          </form>
          <?php
      ...
      <div class="card border border-dark rounded">
        ...
        <div class="card-body">
          ...
          <a href="courses/javascript.html" class="btn btn-primary">Go to course</a>
          <br>
          <form method="POST">
          <input type="submit" name="javascript_course" value="Register now" class="btn btn-primary"></input>
          </form>
          <?php
      ...
      <div class="card border border-dark rounded">
        ...
        <div class="card-body">
          ...
          <a href="courses/ajax.html" class="btn btn-primary">Go to course</a>
          <br>
          <form method="POST">
          <input type="submit" name="ajax_course" value="Register now" class="btn btn-primary"></input>        
          </form>
          <?php
      ...
      <div class="card border border-dark rounded">
        ...
        <div class="card-body">
          ...
          <a href="courses/html_course.html" class="btn btn-primary">Go to course</a>
          <br>
          <form method="POST">
          <input type="submit" name="html_course" value="Register now" class="btn btn-primary"></input>
          </form>
          <?php
      ...
      <div class="card border border-dark rounded">
        ...
        <div class="card-body">
          ...
          <a href="courses/css.html" class="btn btn-primary">Go to course</a>
          <br>
          <form method="POST">
          <input type="submit" name="css_course" value="Register now" class="btn btn-primary"></input>
          </form>
          <?php
